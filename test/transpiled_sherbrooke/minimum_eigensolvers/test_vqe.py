...
class TestVQE(QiskitAlgorithmsTestCase):
    ...
    def test_using_ref_estimator(self, optimizer):
        ...
        vqe = VQE(self.estimator_without_noise, self.ryrz_wavefunction, optimizer)
        ...
        with self.subTest(msg="assert return ansatz is set"):
            estimator = self.estimator_without_noise
    ...
    def test_ansatz_resize(self):
        ...
        vqe = VQE(self.estimator_without_noise, ansatz, SLSQP())
    ...
    def test_reuse(self):
        ...
        vqe = VQE(self.estimator_without_noise, ansatz, SLSQP(maxiter=300))
    ...
    def test_default_batch_evaluation_on_spsa(self):
        ...
        wrapped_estimator = self.estimator_without_noise
        inner_estimator = self.estimator_without_noise
    ...
    def test_optimizer_callable(self):
        ...
        ansatz = RealAmplitudes(1, reps=1)
        vqe = VQE(self.estimator_without_noise, ansatz, _mock_optimizer)
    ...
    def test_aux_operators_list(self):
        ...
        vqe = VQE(self.estimator_without_noise, self.ry_wavefunction, SLSQP(maxiter=300))
